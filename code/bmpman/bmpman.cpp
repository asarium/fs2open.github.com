 ...
 */
static int bm_load_sub_slow(const char *real_filename, const int num_ext, const char **ext_list, cfile::FileHandle **img_cfp = NULL, cfile::DirType dir_type = cfile::TYPE_ANY);
 ...
 */
static int bm_load_sub_fast(const char *real_filename, int *handle, cfile::DirType dir_type = cfile::TYPE_ANY, bool animated_type = false);
...
int bm_load_and_parse_eff(const char *filename, cfile::DirType dir_type, int *nframes, int *nfps, int *key, BM_TYPE *type) {
...
int bm_load_sub_fast(const char *real_filename, int *handle, cfile::DirType dir_type, bool animated_type) {
...
int bm_load_sub_slow(const char *real_filename, const int num_ext, const char **ext_list, cfile::FileHandle **img_cfp, cfile::DirType dir_type) {
	size_t rval;
