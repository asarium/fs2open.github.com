...
typedef struct screen {
	...
	int (*gf_bm_load)(BM_TYPE type, int n, const char *filename, cfile::FileHandle *img_cfp, int *w, int *h, int *bpp, BM_TYPE *c_type, int *mm_lvl, int *size);
...
__inline int gr_bm_load(BM_TYPE type, int n, const char *filename, cfile::FileHandle *img_cfp = NULL, int *w = 0, int *h = 0, int *bpp = 0, BM_TYPE *c_type = 0, int *mm_lvl = 0, int *size = 0)
{
